...
class ReportMasterIdTest {
  ...
  public void testReportMasterID() {
    ...
    ReportMasterId reportMasterId1 = new ReportMasterId(
        UUID.fromString("c81d4e2e-bcf2-11e6-869b-7df92533d2db"), "warehouse1");
    assertEquals(UUID.fromString("c81d4e2e-bcf2-11e6-869b-7df92533d2db"),
        reportMasterId.getReportId());
    assertEquals("warehouse1", reportMasterId.getReportName());
  }
  ...
  public void testEquals_Hash() {
    ReportMasterId x = new ReportMasterId(UUID.fromString("c81d4e2e-bcf2-11e6-869b-7df92533d2db"),
        "warehouse1");
    ReportMasterId y = new ReportMasterId(UUID.fromString("c81d4e2e-bcf2-11e6-869b-7df92533d2db"),
        "warehouse1");
